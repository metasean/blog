...
Since that fateful day, the SLC JS Learners' group has grown to more than 600 members, so big we're actually merging into the UtahJS group, but it also means I've helped get a lot of novices up and running!  The following resources are the things I most frequently share with my fellow learners.  
